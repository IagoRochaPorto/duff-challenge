...
function makeDeleteBeer() {
    const useCase = new usecases_1.DeleteBeer(new beerRepository_1.BeerRepository());
    return new grpcUseCaseAdapter_1.GrpcUseCaseAdapter(useCase);
}
exports.makeDeleteBeer = makeDeleteBeer;
